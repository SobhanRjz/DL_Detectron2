...
if __name__ == "__main__":
    ...
    basic_annotation_path = cleaner.paths.output / "_annotations.coco.json"
    manual_annotation_path = cleaner.paths.output / "ManualAnnotation.json" # Should be annotatated by your own
