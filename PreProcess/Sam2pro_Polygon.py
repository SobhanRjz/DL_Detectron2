...
class SAM2PolygonConverter:
    def __init__(self):
        ...
        # Set paths
        self.folder_images = Path(r"C:\Users\sobha\Desktop\detectron2\Data\RoboFlowData\4.aaaaaaaa.v2i.coco\combined")
        self.final_json_modify_path = self.folder_images / "Final_Pro_Polygon.json"
        self.final_json_path = self.folder_images / "Final.json"
